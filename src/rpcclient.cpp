...
std::string HelpMessageCli(bool mainProgram)
{
    ...
    strUsage += "  -rpcport=<port>        " + _("Connect to JSON-RPC on <port> (default: 16043 or testnet: 26043)") + "\n";
    ...
    if(mainProgram)
    {
        ...
        strUsage += "\n" + _("SSL options: (see the VintageTimePieceCoin Wiki for SSL setup instructions)") + "\n";
