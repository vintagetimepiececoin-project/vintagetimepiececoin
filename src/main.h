...
static const int64_t DUST_SOFT_LIMIT = 100000000; // 1 VTPC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64_t DUST_HARD_LIMIT = 1000000;   // 0.01 VTPC mininput
...
static const int64_t CHECK_POW_FROM_NTIME = 1526882400;
#ifdef USE_UPNP
...
static const int64_t COIN_YEAR_REWARD = 12 * CENT; // 12% per year (1% per month)
