...
// Copyright (c) 2014 The VintageTimePieceCoin developers
 ...
 * owners of VintageTimePieceCoin to participate in minting.
 ...
 * VintageTimePieceCoin, it's highly UNLIKELY that this set of
